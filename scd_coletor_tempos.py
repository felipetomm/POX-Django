...
if __name__=="__main__":
    for testes in range(0,40):
        #INICIA COLETANDO OS SWITCHES
        switches = scd_get_switches()

        #VARIAVEL LISTA QUE ARMAZENA TUDO (SWITCHES E FLOWS DE CADA SWITCH)
        scd_root = []
        ...
        for switch in switches:
            ...
            tempo_1 = time.clock()-tempo_ini
            tempo_1_final += tempo_1
        ...
        #print ("Modulo de Coleta demorou: %s" %(tempo_1_final))
        ...
        tempo_ini = time.clock()
        #PRIMEIRO FAZ O FOR PARA A LISTA ROOT
        for scd_flow_main_list in scd_root:
        ...
        tempo_3 = time.clock()-tempo_ini
        #print ("Final: %s / %s / %s" %(tempo_1_final,tempo_2,tempo_3))
        print ("%s / %s" %(tempo_1_final,tempo_3))